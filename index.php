...
<head>
    ...
    <title>Login Page - Sistema de Gestão de Conteúdo (CSM)</title>
                    ...
                    <div class="auth-inner row m-0">
                        ...
                        <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5">
                            <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                                <h2 class="card-title fw-bold mb-1">Bem Vindo (a)! 👋</h2>
                                <p class="card-text mb-2">Por favor, faça login na sua conta e comece a aventura</p>
                                <?php if (!empty($erro)): ?>
                                ...
                                <form class="auth-login-form mt-2" action="index.php" method="POST">
                                    ...
                                    <div class="mb-1">
                                        <div class="d-flex justify-content-between">
                                            <label class="form-label" for="login-password">Senha</label><a href="auth-forgot-password-cover.html"><small>Esqueceu a Senha?</small></a>
                                        </div>
                                ...
                                <p class="text-center mt-2"><span>Novo na plataforma?</span><a href="auth-register-cover.html"><span>&nbsp;Criar uma Conta</span></a></p>
